...
class EncoderRNN(nn.Module):
    ...
    def forward(self, source_sentence, hidden):
        ...
        print(source_sentence.get_device())
        print(self.embedding.weight.get_device())
    ...
    def init_hidden(self, batch_size):
        ...
        ## For GPU run only
        if torch.cuda.is_available(): hidden = Variable(torch.zeros(self.n_layers, batch_size, self.hidden_size).cuda())
        return hidden
