...
def train(encoder, decoder, encoder_optimizer, decoder_optimizer, criterion, epoch, teacher_forcing_ratio=1.0):
...
# Toy run
train_batch = next(iter(train_iter))
src = train_batch.src # -> device 1
trg = train_batch.trg

for epoch in range(0, 1):
  	print(train( encoder, decoder, encoder_optimizer, decoder_optimizer, criterion, epoch, teacher_forcing_ratio = 1.0) )
